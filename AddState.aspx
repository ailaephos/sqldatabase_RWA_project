<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddState.aspx.cs" Inherits="rwa_projekt_katlija_2407.AddState" UnobtrusiveValidationMode="none" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="container status-container">
        <h1 style="width: 225px; margin-top: -12px;">AdventureWorksOBP - states</h1>
            <div class="contbtnh" style="text-align: center;">              
                <h2 class="addstateheader" style="margin-left:0px;">Add a new state</h2>          
           </div>
      
        <label  class="txtadd">Name: </label>
        <asp:TextBox ID="AddAState" runat="server" CssClass="my-textBox"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="State name must be declared." ControlToValidate="AddAState" Display="none"></asp:RequiredFieldValidator>
